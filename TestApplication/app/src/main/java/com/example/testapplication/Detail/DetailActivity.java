...
import com.example.testapplication.Adapters.CarAdapter;
...
import static com.example.testapplication.Main2Activity.CLEARCAR_ACTION;
...
public class DetailActivity extends BaseActivity implements AddWidget.OnAddClick {
	...
	private void initShopCar() {
		...
		flist.addAll(Main2Activity.carAdapter.getData());
	...
	private void dealCar(FoodBean foodBean) {
		...
		Intent intent = new Intent(Main2Activity.CAR_ACTION);
